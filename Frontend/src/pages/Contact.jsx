    ...
    <div>
      ...
      <img className='w-full md:max-w-[360px]' src={assets2.contact_image} alt="contact_image" />
        <div className='flex-1 border border-gray-400 rounded-lg p-8 py-7 mx-2 text-sm text-gray-600 bg-white sm:mx-0 mt-[-80px] sm:mt-0 '>
          ...
          <a href='https://www.linkedin.com/jobs/' target='_blank' rel='noopener noreferrer' className='inline-block text-black px-4 py-2 rounded mt-2 hover:bg-black hover:text-white border border-black transition-all duration-300'>explore jobs</a>
        </div>
      </div>
    </div>
  )
